                    ...
                    <thead className="text-xs text-gray
                        ...
                        <tr className="text-nowrap">
                            ...
                            <th className="px-3 py-3">
                                <TextInput className="w-full" placeholder="Task Name" onBlur={e => searchFieldChanged('name', e.target.value)} onKeyPress={e => onKeyPress('name', e)} defaultValue={queryParams.name} />
                            </th>
                            <th className="px-3 py-3">
